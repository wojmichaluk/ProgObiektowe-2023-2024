...
//napisane analogicznie do BehaviorSpec
class BouncyMapFeatureSpec: FeatureSpec({
    feature("Empty Bouncy Map and some animals") {
        val animal1 = Animal()
        ...
        feature("Some animals moved"){
            ...
            scenario("Now it should look like that"){
        ...
        feature("Some animals try to fight or escape..."){
            ...
            scenario("...but neither can they fight..."){
